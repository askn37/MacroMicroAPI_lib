...
class OLED_SH1106_Class : public Print {
private:
...
public:
  inline OLED_SH1106_Class (TWIM_Class _twim, const uint8_t _fontset[]) : TWIC(_twim), FontSet((uint8_t*)_fontset) {}
  ...
  inline OLED_SH1106_Class& setFontSet (const uint8_t* _ptr) { FontSet = (uint8_t*)_ptr; return *this; }
  inline OLED_SH1106_Class& setExtTableInROM (const uint8_t* _ptr) { ExtraROMSet = (uint8_t*)_ptr; return *this; }
  inline OLED_SH1106_Class& setExtTableInRAM (void* _ptr) { ExtraRAMSet = (uint8_t*)_ptr; return *this; }
  ...
  inline OLED_SH1106_Class& send (const uint8_t _c) { write(_c); return *this; }
  inline OLED_SH1106_Class& send (const char* _buffer, size_t _length) {
